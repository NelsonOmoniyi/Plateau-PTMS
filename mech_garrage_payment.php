            ...
            <div class="col-md-12">
                <div class="card">
                    <div id="" class="card-body">
                        <h3 class="text-center">Mechanic Garrage Registration</h3>
                        <hr>
                        ...
                        <section id="step_one" class="text-center">
                            <p>To Register Your Mechanic Garrage:<hr> <br> Enter Your Portal ID, Verify Your Details, Make Online Payment and Generate Receipt.</p>
                            <div>
                        ...
                        <section id="step_two" class="d-none">
                            <form id="form1" onsubmit="return false">
                                <input type="hidden" value="MechanicGarrage.validatePID" name="op">
                                <div class="row ">
                        ...
                        <section id="step_three" class="d-none">
                            <p class="text-center">
                                ...
                                <span class="text-mute">kindly contact or visit <em>Ministry Of Transport</em> if any information provided below is incorrect</span></span>
                            </p>
                            <form id="form2" onsubmit="return false">
                                <input type="hidden" value="MechanicGarrage.checkDetails" name="op">
                        ...
                        <section id="step_four" class="d-none">
                            ...
                            <form id="form3" onsubmit="return false">
                                ...
                                <input type="hidden"  name="table" value="mech_garrage">
                                <div class="row">
