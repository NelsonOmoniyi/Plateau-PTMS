...
$DSL =$dbobject->db_query("SELECT * FROM driving_sch_form WHERE portal_id = '$portal_id'");
$LL = $DSL[0];
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div style="color: green; font-weight: bold;">
                                ...
                                <span class="text-600 text-110 text-blue align-middle"><?php echo $LL['school_name'];?></span>
                            </div>
                            <hr>
                            <div class="text-grey-m2">
                                ...
                                <div class="my-1"><small style="color: blue; font-size: 20px;">Proprietors Name :</small>
                                    <?php echo' '.$LL['proprietor_name'];?>
                                </div>
