...
class Dealers extends dbobject
{
    ...
    public function dls_list($data)
    {
        ...
        $columner = array(
            ...
            array( 'db' => 'sponsor',  'dt' => 7 ),
            array( 'db' => 'license_union',  'dt' => 8 ),
    ...
    public function validatePID($data){
        ...
        if ($result == NULL) {
            ...
            if ($count > 0) {
                ...
                return json_encode(array('response_code'=>'909', 'response_message'=>'Incomplete Dealership Licence Process, Please Contact An Administrator'));
            }
