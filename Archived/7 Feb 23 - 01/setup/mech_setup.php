...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold">Mechanic Garrage Setup</h4>
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="MechanicGarrage.saveMech">
       ...
       <div class="row">
           ...
           <div class="col-sm-4">
               <div class="form-group">
                    ...
                    <input type="text" name="cac_reg_no" class="form-control" value=<?php echo $cac; ?> placeholder="" required readonly>
                </div>
           </div>
           <div class="col-sm-4">
               <div class="form-group">
...
<script>
    ...
    function saveRecord()
    {
        ...
        function PrintPage(d) {
            window.open('receipt/special_trade_invoice.php?table=mech_garrage&pid='+d, '_blank');
	}
    }
