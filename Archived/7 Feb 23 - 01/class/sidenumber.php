            ...
            if($data['operation'] == "new")
            {
                ...
                if($result > 0){
                    if ($result[0]['status'] == '1') {
                        ...
                        if(!$result1 > 0){
                            $insert = "INSERT into plate (Name,plate,chasis,veh_make,veh_color,veh_model,phone) VALUES ('$fullname','$plate','$chasis','$make','$color','$model','$phone')";
                        ...
                        $insert2 = "INSERT INTO tb_payment_confirmation (payment_code, trans_desc, trans_amount, trans_status, officer,client_fullname,trans_desc_code, tin, item_code) VALUES ('$SDN', 'Side Number Registration', '$amount', '1', '$officer','$fullname', 'SNR', '$tin', '$item_code')";
