    ...
    public function saveDSD($data)
    {
        ...
        if($data['operation'] == "new")
        {
            ...
            if(!$validation['error'])
            {
                ...
                // $paid = count($result);
                // if(!$paid > 0){
                    $insert2 = "INSERT INTO tb_payment_confirmation (payment_code, trans_desc, trans_amount, trans_status, officer,client_fullname,trans_desc_code, tin, item_code) VALUES ('$portal_id', 'Driving School Registration', '$amount', '$pending', '$officer', '$name', '$trans_code', '$tin', '$item_code')";
