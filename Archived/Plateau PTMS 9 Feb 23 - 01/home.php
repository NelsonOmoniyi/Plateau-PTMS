...
$photo = $check[0]['photo'];
$photo = (($photo == "")?"https://us.123rf.com/450wm/anatolir/anatolir2011/anatolir201105528/159470802-jurist-avatar-icon-flat-style.jpg?ver=6":"img/profile_photo/$photo");
...
<body>
	<div class="wrapper">
		<nav class="sidebar">
		  ...
		  <img src="img/logo/plateau_logo.jpg" alt="Plateau State Ministry Of Transport" class="img-fluid rounded-circle" style="max-height:35px;"/> <span class="text-dark text-bold"><b>PLMOT</b></b</span>
				...
				<div class="sidebar-bottom d-none d-lg-block">
					<div class="media">
						...
						<div class="media-body">
							<h5 class="mb-1">Welcome back, <?php echo $_SESSION['firstname_sess'].' '.$_SESSION['lastname_sess']; ?></h5>
							<div>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
			  ...
			  <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-toggle="dropdown">
                <img src="<?php echo $photo ?>" class="avatar img-fluid rounded-circle mr-1" alt=""/> <span class="text-dark"><?php echo $_SESSION['firstname_sess'].' '.$_SESSION['lastname_sess']; ?></span>
              </a>
