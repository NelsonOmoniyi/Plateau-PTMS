            ...
            if(!$validation['error'])
            {
                ...
                if(!$paid > 0){
                    ...
                    if ( $Tstatus == $processed ) { 
                        $sql   = "SELECT * FROM mech_garrage WHERE tin = '$tin' LIMIT 1";
                        $result = $this->db_query($sql);
    ...
    public function validatePID($data){
        ...
        if ($result == NULL) {
            ...
            if ($count > 0) {
                ...
                return json_encode(array('response_code'=>'909', 'response_message'=>'Incomplete Mechanic Garrage Licence Process, Please Contact An Administrator'));
            }
