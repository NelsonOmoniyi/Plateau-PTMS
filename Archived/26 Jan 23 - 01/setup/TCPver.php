...
$sql = "SELECT * FROM payment_category WHERE code = 'TCP'";
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="TCP.verTIN">
       ...
       <div class="row">
           ...
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="number" name="cac" class="form-control" required>
                </div>
           </div>
        </div>
        <div class="row">
    ...
    <p>I dont have a Tax Identification Number! <small><a class="btn btn-warning" onclick="regTin()">Generate Tin</a></small>
...
<script>
   ...
   {
    setTimeout(() => {
        getModal('setup/transport_comp_setup.php?title='+title+'&firstname='+firstname+'&middlename='+middlename+'&surname='+surname+'&mobile='+mobile+'&address='+address+'&tin='+tin+'&name='+name+'&item='+item+'&price='+price,'modal_div');
    }, 2000);
   }
   function regTin(){
