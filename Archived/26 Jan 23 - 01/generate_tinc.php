       ...
       <div class="row">
           <div class="col-sm-4">
               <div class="form-group">
                    ...
                    <input type="text" name="rc_number" id="rc" class="form-control">
                </div>
           </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="form-label">State Of Origin <span class="text-danger">*</span></label>
                    <input type="text" name="soo" id="soo" class="form-control">
                </div>
           </div>
           <div class="col-sm-4">
               <div class="form-group">
       ...
       <div class="row">
           ...
           <div class="col-sm-4">
               <div class="form-group">
                    ...
                    <input type="text" name="nationality" id="nationality" value="Nigerian" readonly class="form-control">
                </div>
           </div>
       </div>
       <div class="row">
       ...
       <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" name="blocation" id="blocation" class="form-control">
                </div>
           </div>
           <div class="col-sm-4">
               <div class="form-group">
                    <label class="form-label"> State <span class="text-danger">*</span></label>
                    <input type="text" name="state" value="Plateau State" readonly id="state" class="form-control">
                </div>
           </div>
       </div>
       <div class="row">
