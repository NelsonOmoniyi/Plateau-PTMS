        ...
        $role = $this->getitemlabel('role','role_id',$data['role_id'],'role_name');
            ...
            if($data['operation'] != 'edit')
            {
                ...
                <div style="width:500px; background:white; margin:0px auto; padding:25px;">
                    ...
                    <p style="background-color:#36b466; color:white; font-size:18px; text-align:center; padding:8px;">Plateau State Ministry of Transport</p>
                    <h3 style="text-align:center;">Password Reset</h3>
                    <p style="text-align:center;">Dear '.$data['lastname'].', An account has been created for you on Plateau State Ministry of Transport with Role <b>'.$role.'</b>. Kindly follow this https://techhost7x.accessng.com/plateau_transport/ to visit.</p>
                </div>
