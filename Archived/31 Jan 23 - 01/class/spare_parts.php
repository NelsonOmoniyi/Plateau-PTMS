    ...
    public function saveSpare($data)
    {
        ...
        if($data['operation'] == "new")
        {
            ...
            if(!$validation['error'])
            {
                ...
                // if(!$paid > 0){
                    $insert2 = "INSERT INTO tb_payment_confirmation (payment_code, trans_desc, trans_amount, trans_status, officer,trans_desc_code, tin, item_code) VALUES ('$portal_id', 'Spare Parts Dealership Registration', '$amount', '$pending', '$officer', '$trans_code', '$tin', '$item_code')";
