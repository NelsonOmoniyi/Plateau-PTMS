...
$pdf->Ln(16);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(114,0,custom_echo($owner_name,$length),0,1,'C');
...
$pdf->Ln(6);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(101,0,$check[0]['phone'],0,1,'C');
...
$pdf->Ln(15);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(307,0,$owner_name,0,1,'C');
...
$pdf->Ln(10);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(301,0,$check[0]['portal_id'],0,1,'C');

// Payment type right
$pdf->SetFont('Arial', '', 10);
$pdf->Ln(8);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(309,1,$payt_type,0,1,'C');

// Amount right
$pdf->SetFont('Arial', '', 10);
$pdf->Ln(9);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(300,0,$money,0,1,'C');

// TIN right
$pdf->SetFont('Arial', '', 10);
$pdf->Ln(10);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(297,0,$check[0]['tin'],0,1,'C');

// Phone right
$pdf->SetFont('Arial', '', 10);
$pdf->Ln(9);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(295,0,$check[0]['phone'],0,1,'C');

// Date right
$pdf->SetFont('Arial', '', 10);
$pdf->Ln(9);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(298,0,$created,0,1,'C');
