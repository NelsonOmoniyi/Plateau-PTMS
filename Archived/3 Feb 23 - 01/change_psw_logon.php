									...
									<form id="form1">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input aria-label="Password" type="password" autocomplete="off" name="current_password" placeholder="Enter your current password" id="password" class="form-control form-control-lg" />
