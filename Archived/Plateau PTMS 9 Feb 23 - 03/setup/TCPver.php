...
<script>
    ...
    setTimeout(() => {
        getModal('setup/transport_comp_setup.php?title='+title+'&firstname='+firstname+'&middlename='+middlename+'&surname='+surname+'&mobile='+mobile+'&address='+address+'&tin='+tin+'&name='+name+'&item='+item+'&price='+price+'&cac='+cac,'modal_div');
    }, 2000);
   }
   function regTin(){
