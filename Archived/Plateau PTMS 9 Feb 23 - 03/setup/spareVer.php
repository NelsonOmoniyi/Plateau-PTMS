...
$sql = "SELECT * FROM payment_category WHERE code = 'SPD'";
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="Spare.verTIN">
...
<script>
   ...
   {
    setTimeout(() => {
        getModal('setup/spare_setup.php?title='+title+'&firstname='+firstname+'&middlename='+middlename+'&surname='+surname+'&mobile='+mobile+'&address='+address+'&tin='+tin+'&name='+name+'&item='+item+'&price='+price+'&cac='+cac,'modal_div');
    }, 2000);
   }
