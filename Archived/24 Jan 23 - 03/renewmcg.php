            ...
            <div class="col-md-12">
                <div class="card">
                    <div id="" class="card-body">
                        <h3 class="text-center">Spare Parts Dealership Renewal</h3>
                        <hr>
                        ...
                        <section id="step_oner" class="text-center">
                            <form id="form1" onsubmit="return false">
                                <input type="hidden" value="Renewal.confirm_portMCG" name="op">
                                <div class="row">
                        ...
                        <section id="step_twor" class="d-none">
                            ...
                            <form id="form2" onsubmit="return false">
                                <input type="hidden" value="Renewal.checkMCG" name="op">
                                <input type="hidden" value="" name="port" id="port">
                                <input type="hidden" value="MCG" name="desc_code" id="port">
                                <input type="hidden" value="Mechanic Garrage Renewal" name="description" id="port">
                                <div class="row ">
                                    <div class="form-group col-md-6">
