...
$sql = "SELECT * FROM payment_category WHERE code = 'TPU'";
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="TPU.verTIN">
       ...
       <div class="row">
        ...
        <div class="row">
           <div class="col-md-6">
                <label>Transport Union Category</label>
                
                <select name="cat" class="form-control" required>
                    <option hidden value="">:: SELECT UNION CATEGORY::</option>
                    <?php
...
<script>
   ...
   {
    setTimeout(() => {
        getModal('setup/trans_union_setup.php?title='+title+'&firstname='+firstname+'&middlename='+middlename+'&surname='+surname+'&mobile='+mobile+'&address='+address+'&tin='+tin+'&name='+name+'&item='+item+'&price='+price,'modal_div');
    }, 2000);
   }
