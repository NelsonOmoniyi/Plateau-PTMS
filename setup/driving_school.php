       ...
       <div class="row">
           ...
           <div class="col-sm-3">
               <div class="form-group">
                    ...
                    <input type="text" name="address" class="form-control" value="<?php echo $address ;?>" placeholder="" required readonly>
                </div>
           </div>
           <div class="col-sm-3">
               <div class="form-group">
       ...
       <div class="row">
           ...
           <div class="col-sm-3">
               <div class="form-group">
                    ...
                    <input type="text" name="phone" value="<?php echo $mobile; ?>" class="form-control" placeholder="" required readonly>
                </div>
           </div>
           <div class="col-sm-3">
               <div class="form-group">
...
<script>
    ...
    function PrintPage(d) {
            // window.alert(d)
            // window.open('setup/printDSLpin.php?id='+d, '_blank');
            window.open('./print/printDSL.php?id='+d, '_blank');
            // getpage('setup/printDSL.php?id='+d,'page');
