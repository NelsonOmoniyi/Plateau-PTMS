            ...
            <div class="col-md-12">
                <div class="card">
                    <div id="" class="card-body">
                        <h3 class="text-center">Transport Companies Registration</h3>
                        <hr>
                        ...
                        <section id="step_one" class="text-center">
                            <p>To Register Your Transport Company:<hr> <br> Enter Your Portal ID, Verify Your Details, Make Online Payment and Generate Receipt.</p>
                            <div>
                        ...
                        <section id="step_two" class="d-none">
                            <form id="form1" onsubmit="return false">
                                <input type="hidden" value="TCP.validatePID" name="op">
                                <div class="row ">
                        ...
                        <section id="step_three" class="d-none">
                            ...
                            <form id="form2" onsubmit="return false">
                                <input type="hidden" value="TCP.checkDetails" name="op">
