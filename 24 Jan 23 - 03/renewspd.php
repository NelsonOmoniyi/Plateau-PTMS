                    ...
                    <div id="" class="card-body">
                        ...
                        <section id="step_oner" class="text-center">
                            <form id="form1" onsubmit="return false">
                                <input type="hidden" value="Renewal.confirm_portSP" name="op">
                                <div class="row">
                        ...
                        <section id="step_twor" class="d-none">
                            ...
                            <form id="form2" onsubmit="return false">
                                <input type="hidden" value="Renewal.checkSP" name="op">
                                <input type="hidden" value="" name="port" id="port">
                                <input type="hidden" value="SPD" name="desc_code" id="port">
                                <input type="hidden" value="Spare Parts Dealership Renewal" name="description" id="port">
                                <div class="row ">
                                    <div class="form-group col-md-6">
