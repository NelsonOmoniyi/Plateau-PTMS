...
$img = ($_SESSION['photo_path_sess']=="img/profile_photo/" || $_SESSION['photo_path_sess']=="")?"https://us.123rf.com/450wm/anatolir/anatolir2011/anatolir201105528/159470802-jurist-avatar-icon-flat-style.jpg?ver=6":$_SESSION['photo_path_sess'];
							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<img src="<?php echo $img; ?>" alt="<?php echo $_SESSION['firstname_sess']?>" width="132" height="132" class="img-fluid rounded-circle"/>
									</div>
									<form id="form1" class="mt-3">
										...
										<div class="text-center mt-3 mb-2">
											...
											<a href="login.html">I remember now.</a>
										</div>
									</form>
								</div>
							</div>
