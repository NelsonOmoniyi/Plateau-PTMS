      ...
      <div class="container">
        ...
        <div class="bg-light" style="padding:35px;">
                    <h3 class="text-light text-center"
                        ...
                        Dealership Registration or Renewal?</h3>
                </div>
          ...
          <div class="col-sm-6">
            ...
            <div class="bg-light" style="padding:35px;">
                        ...
                        Dealership Registration</h3>
                        <p style="font-size:13px; color:#8d8ea3;">Pay For Your Dealership Licence</p>
                    </div>
          ...
          <div class="col-sm-6">
            ...
            <div class="bg-light" style="padding:35px;">
                        <h3 class="text-light" style="font-size:18px; font-weight:bolder; color:#395b25 !important;">
                        Dealership Licence Renewal</h3>
                        <p style="font-size:13px; color:#8d8ea3;">Renew Your Dealership Licence</p>
                    </div>
