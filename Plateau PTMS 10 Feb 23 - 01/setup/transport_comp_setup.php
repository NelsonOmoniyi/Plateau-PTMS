        ...
        <div class="row">
           <div class="col-sm-12">
               <div class="form-group">
                    ...
                    <p><span><input type="radio" name="agreement" class="form-control-sm mt-3" placeholder="" value="1" required></span> I agree that the information provided in this application is true and binding on me.</p>
                </div>
           </div>
       </div>
