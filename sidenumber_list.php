...
?>
   <div class="card">
    <div class="card-header">
        <h5 class="card-title">Side Number List</h5>
    ...
    <div class="card-body">
      <?php if($_SESSION['role_id_sess'] != 001){
          echo "<a class='btn btn-warning' onclick=\"getModal('setup/verify_tin.php','modal_div')\" data-toggle=\"modal\" data-target=\"#defaultModalPrimary\" href=\"javascript:void(0)\">Generate Side-Number</a>";
      }else{
        // echo "Super Admin!!";
      }
      ?>
...
<script>
  ...
  var table;
  var editor;
  var op = "Sidenumber.SideNum_list";
...
//        $('#'+div).block({ message: null });
    ...
    function PrintPage(d) {
            // window.alert(d)
            window.open('./print/printSN.php?id='+d, '_blank');
