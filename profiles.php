        ...
        <div class="col-md-4 col-xl-3" id="photo_display">
            <div class="card mb-3">
                ...
                <div class="card-body text-center">
                    <img src="<?php echo $_SESSION['photo_path_sess']; ?>" id="avatar_profile" alt="Stacie Hall"
...
<link rel="stylesheet" href="css/uploadfile.css" integrity="<?php echo $dbobject->CORS('css/uploadfile.css') ?>"
    crossorigin="<?php echo $crossorigin ?>">
<script src="js/jquery.uploadfile.min.js" integrity="<?php echo $dbobject->CORS('js/jquery.uploadfile.min.js') ?>"
    crossorigin="<?php echo $crossorigin ?>"></script>
<script>
