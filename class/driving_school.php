    ...
    public function verdTIN($data){
        ...
        if(!$validation['error'])
        {
            ...
            if ($resArr['status'] == 'success') {
                ...
                return json_encode(array('response_code'=>'200', 'response_message'=>'Valid Tax Identification Number','title'=>$title,'firstname'=>$firstName,'middleName'=>$midName,'surname'=>$Surname,'tin'=>$tin,'mobile'=>$mobile,'address'=>$address ));
            ...
            if(!$validation['error'])
            {
                ...
                if(!$paid > 0){
                    ...
                    if ( $Tstatus == $processed ) { 
                        ...
                        return json_encode(array('response_code'=>407,'response_message'=>'This TIN '.$tin.' Have Been Used And Payment For This Driving School Licence Have Not Been Made! <a href="../driving_school_payment.php">Kindly Click On This Link To Make Payment</a>'));
                    }
                }
            }else
            {
