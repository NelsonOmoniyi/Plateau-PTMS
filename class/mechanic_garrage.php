            ...
            if(!$validation['error'])
            {
                ...
                if(!$paid > 0){
                    ...
                    if ( $Tstatus == $processed ) { 
                        ...
                        return json_encode(array('response_code'=>407,'response_message'=>'This TIN '.$tin.' Have Been Used And Payment For This Mechanic Garage Licence Have Not Been Made! <a href="../driving_school_payment.php">Kindly Click On This Link To Make Payment</a>'));
                    }
                }
            }else
            {
