...
$id = isset($_REQUEST['id'])?$_REQUEST['id']:'';
// echo $id;
$sql = $dbobject->db_query("SELECT * FROM transport_companies WHERE portal_id = '$id'");
...
$pdf->Ln(87);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(335,115,"Transport Companies Renewal",0,1,'C');

$pdf->SetFont('Arial', 'B', $font_size);
$pdf->Ln(87);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(110,-298.5,"Transport Companies",0,1,'C');
} else {

$pdf->SetFont('Arial', 'B', $font_size);
$pdf->Ln(87);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(335,115,"Transport Companies Registration",0,1,'C');
