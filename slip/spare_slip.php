...
$pdf->SetX(146);
$pdf->MultiCell(55,5,$address,0,'L');

$pdf->SetFont('Arial', '', $font_size);
$pdf->Ln(-16);
$pdf->SetTextColor(10,70,100);
$pdf->SetX(50);
$pdf->MultiCell(40,5,$address,0,'L');
...
$pdf->Ln(-12);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(296,40,$cac,0,1,'C');

$pdf->SetFont('Arial', '', $font_size);
$pdf->Ln(-26);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(103,1,$cac,0,1,'C');

// portal ID
$pdf->SetFont('Arial', '', $font_size);
$pdf->Ln(14);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(300,1,$portal_id,0,1,'C');

$pdf->SetFont('Arial', '', $font_size);
$pdf->Ln(-6);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(108,0,$portal_id,0,1,'C');
...
$pdf->Ln(-5);
$pdf->SetTextColor(10,70,100);
$pdf->Cell(114,0,$payt_type,0,1,'C');  
