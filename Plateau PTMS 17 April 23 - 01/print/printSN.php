...
// reprocessing SN
// $ip = ['13.41.180.63','41.242.60.178','65.61.149.231', '192.168.80.72'];
...
// values(NULL,'$side','$amount','$renewal_amount', NOW(),'$expDate','$expDate','null')";
...
$sql= "SELECT * FROM vehicle_sidenumbers WHERE brn = '$brn' LIMIT 1";
$vehicle_sidenumbers = $dbobject->db_query($sql);
$data = $vehicle_sidenumbers[0];
// echo($sql);exit;
$paytStatus = $data['status'];
