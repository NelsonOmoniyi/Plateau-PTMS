...
// added
$renewSql = "UPDATE $table SET approved = '1' WHERE portal_id = '$id'";
...
<div class="modal-body m-3" id="modal">
    <div class="container-fluid">
        <table class="table table-bordered table-striped">
            ...
            <tr><th>Capacity</th><td><?php echo $check[0]['cap'] ?></td></tr>
...
<a href="<?php echo "$link?id=$id&table=$table" ?>" target="_blank" class="btn btn-primary" id="click">Print</a>
</div>
<script>
