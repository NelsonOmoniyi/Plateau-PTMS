            ...
            <div class="col-md-12">
                <div class="card">
                    <div id="" class="card-body">
                        <h3 class="text-center">Auto Dealership Renewal</h3>
                        <hr>
                        ...
                        <section id="step_oner" class="text-center">
                            <form id="form1" onsubmit="return false">
                                <input type="hidden" value="Renewal.confirm_portDLS" name="op">
                                <div class="row">
                        ...
                        <section id="step_twor" class="d-none">
                            ...
                            <form id="form2" onsubmit="return false">
                                <input type="hidden" value="Renewal.checkDLS" name="op">
                                <input type="hidden" value="" name="port" id="port">
                                <input type="hidden" value="DLS" name="desc_code" id="port">
                                <input type="hidden" value="Dealership Renewal" name="description" id="port">
                                <div class="row ">
